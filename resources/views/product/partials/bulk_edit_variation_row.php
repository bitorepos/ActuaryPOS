...
<td>
	<div class="input-group">
		<span class="input-group-text"><small><?php echo app('translator')->get('product.exc_of_tax'); ?></small></span>
	...
	<div class="input-group">
		<span class="input-group-text"><small><?php echo app('translator')->get('product.inc_of_tax'); ?></small></span>
...
<td style="text-align: left;">
	<?php $__currentLoopData = $price_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		...
		<div class="input-group" style="width: 100%;">
			<span class="input-group-text"><small><?php echo e($v, false); ?> -</small></span>
