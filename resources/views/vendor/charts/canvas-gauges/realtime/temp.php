...
<script type="text/javascript">
    $(function (){
        var <?php echo e($model->id, false); ?> = new LinearGauge({
          ...
          highlights: [
                ...
                <?php else: ?>
                    ...
                    { from: <?php echo e($min, false); ?>, to: <?php echo e($low_warning, false); ?>, color: 'rgba(0,258,0,.15)' },
        ...
        setInterval(function(){
            $.getJSON("<?php echo e($model->url, false); ?>", function( data ) {
                <?php echo e($model->id, false); ?>.value = data["<?php echo e($model->value_name, false); ?>"];
            })
