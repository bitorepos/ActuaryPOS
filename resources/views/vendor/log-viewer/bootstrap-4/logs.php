        ...
        <table class="table table-sm table-hover">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="<?php echo e($key == 'date' ? 'text-left' : 'text-center', false); ?>">
                        <?php if($key == 'date'): ?>
                            <span class="badge badge-info"><?php echo e($header, false); ?></span>
                        <?php else: ?>
                            <span class="badge badge-level-<?php echo e($key, false); ?>">
                    ...
                    <tr>
                        <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <td class="<?php echo e($key == 'date' ? 'text-left' : 'text-center', false); ?>">
                                <?php if($key == 'date'): ?>
                                    <span class="badge badge-primary"><?php echo e($value, false); ?></span>
                                <?php elseif($value == 0): ?>
                                    <span class="badge empty"><?php echo e($value, false); ?></span>
                                <?php else: ?>
                                    <a href="<?php echo e(route('log-viewer::logs.filter', [$date, $key]), false); ?>">
                                        <span class="badge badge-level-<?php echo e($key, false); ?>"><?php echo e($value, false); ?></span>
                                    </a>
                                <?php endif; ?>
                            </td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
